...
// ── WebSocket kwa dashboard (inahitaji token sahihi) ──
...
// Taarifa za boti/ukiukaji — TU kwa admin aliyeingia (login)
app.get('/api/boats', requireAuth, (req, res) => res.json(Object.values(boats)));
app.get('/api/alerts', requireAuth, (req, res) => res.json(alertsLog.slice(0, 50)));
app.get('/api/zones', requireAuth, (req, res) => res.json(FORBIDDEN_ZONES));
